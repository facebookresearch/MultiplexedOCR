...
from multiplexer.structures import BoxList, pairwise_iou
...
class BaseROIMaskHead(torch.nn.Module):
    ...
    def forward(self, features, proposals, targets=None):
        ...
        if self.training:
            ...
            gt_language_targets = cat(gt_language_targets, dim=0)
