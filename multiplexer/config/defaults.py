...
# When scaling the recognition loss using ax+b, this is the bias term b
# so that the head is not trained with nothing if a is too small
_C.SEQUENCE.LOSS_WEIGHT_BASE = 0.0
...
_C.SEQUENCE.ANY.EMBED_SIZE = 250
_C.SEQUENCE.ANY.HIDDEN_SIZE = 320

_C.SEQUENCE.ANY1 = CN()
_C.SEQUENCE.ANY1.ARCH = "ctc_lstm"
_C.SEQUENCE.ANY1.NUM_CHAR = 11000
_C.SEQUENCE.ANY1.EMBED_SIZE = 200
_C.SEQUENCE.ANY1.HIDDEN_SIZE = 256

_C.SEQUENCE.ANY2 = CN()
_C.SEQUENCE.ANY2.ARCH = "ctc_lstm"
_C.SEQUENCE.ANY2.NUM_CHAR = 11000
_C.SEQUENCE.ANY2.EMBED_SIZE = 200
_C.SEQUENCE.ANY2.HIDDEN_SIZE = 256

_C.SEQUENCE.ANY3 = CN()
_C.SEQUENCE.ANY3.ARCH = "ctc_lstm"
_C.SEQUENCE.ANY3.NUM_CHAR = 11000
_C.SEQUENCE.ANY3.EMBED_SIZE = 200
_C.SEQUENCE.ANY3.HIDDEN_SIZE = 256

_C.SEQUENCE.ANY4 = CN()
_C.SEQUENCE.ANY4.ARCH = "ctc_lstm"
_C.SEQUENCE.ANY4.NUM_CHAR = 11000
_C.SEQUENCE.ANY4.EMBED_SIZE = 200
_C.SEQUENCE.ANY4.HIDDEN_SIZE = 256

_C.SEQUENCE.ANY5 = CN()
_C.SEQUENCE.ANY5.ARCH = "ctc_lstm"
_C.SEQUENCE.ANY5.NUM_CHAR = 11000
_C.SEQUENCE.ANY5.EMBED_SIZE = 200
_C.SEQUENCE.ANY5.HIDDEN_SIZE = 256

_C.SEQUENCE.ANY6 = CN()
_C.SEQUENCE.ANY6.ARCH = "ctc_lstm"
_C.SEQUENCE.ANY6.NUM_CHAR = 11000
_C.SEQUENCE.ANY6.EMBED_SIZE = 200
_C.SEQUENCE.ANY6.HIDDEN_SIZE = 256

_C.SEQUENCE.ANY7 = CN()
_C.SEQUENCE.ANY7.ARCH = "ctc_lstm"
_C.SEQUENCE.ANY7.NUM_CHAR = 11000
_C.SEQUENCE.ANY7.EMBED_SIZE = 200
_C.SEQUENCE.ANY7.HIDDEN_SIZE = 256
...
_C.MODEL.LANGUAGE_GROUPER = CN()
_C.MODEL.LANGUAGE_GROUPER.FROZEN = False
_C.MODEL.LANGUAGE_GROUPER.GUMBLE_SOFTMAX_TAU = 1
_C.MODEL.LANGUAGE_GROUPER.LOSS_WEIGHT = 1.0
# Minimum number of assigned tasks (languages) for each group (head)
_C.MODEL.LANGUAGE_GROUPER.MIN_TASKS = 1.0
_C.MODEL.LANGUAGE_GROUPER.NAME = "BinaryLanguageGrouper"
