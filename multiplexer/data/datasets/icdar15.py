...
class Icdar15Dataset(IcdarDataset):
    def __init__(
        self,
        name,
        use_charann,
        ...
        """
        super(Icdar15Dataset, self).__init__(
            name,
            use_charann,
            imgs_dir,
            gts_dir,
    ...
    def line2boxes(self, line):
        ...
        assert len(parts) >= 9, "[Error][ICDAR15] line = {}, parts = {}".format(line, parts)
        ...
        if len(parts) > 9:
            ...
            if random.random() < 0.01:
                # log every 100
                print(
                    "[Warning][ICDAR15] line = {}, parts = {}, word = {}".format(line, parts, word)
                )
        else:
            word = parts[8]
