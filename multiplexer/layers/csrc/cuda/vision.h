...
at::Tensor
ROIAlign_forward_cuda(const at::Tensor &input, const at::Tensor &rois,
...
// std::tuple<at::Tensor, at::Tensor> ROIPool_forward_cuda(const at::Tensor&
// input,
//                                 const at::Tensor& rois,
//                                 const float spatial_scale,
//                                 const int pooled_height,
...
//                                     gradInput, at::Tensor gradOffset,
//                                     at::Tensor weight, at::Tensor columns,
//                                     int kW, int kH, int dW, int dH, int padW,
//                                     int padH, int dilationW, int dilationH,
//                                     int group, int deformable_group, int
//                                     im2col_step);
...
//     at::Tensor offset, at::Tensor mask, at::Tensor output, at::Tensor
//     columns, int kernel_h, int kernel_w, const int stride_h, const int
//     stride_w, const int pad_h, const int pad_w, const int dilation_h, const
//     int dilation_w, const int group, const int deformable_group, const bool
//     with_bias);
...
//     deformable_group, const bool with_bias);
