...
def word_spotting_evaluation_params():
    params = default_evaluation_params()
    params["WORD_SPOTTING"] = True
    return params
...
def icdar15_eval_task4(
    ...
    if word_spotting:
        evaluation_params = word_spotting_evaluation_params
    else:
        evaluation_params = default_evaluation_params

    resDict = rrc_evaluation_funcs.main_evaluation(
        p, evaluation_params, validate_data, evaluate_method
    )
...
def icdar15_eval_intermediate(
    ...
    rrc_evaluation_funcs.main_evaluation(p, evaluation_params, validate_data, evaluate_method)
...
#     """
#     results_dir = (
#         "../../../output/mixtrain/inference/icdar_2015_test/model_0250000_1440_results/"
#     )
#     lexicon_type = 3
#     score_det = 0.01
#     score_rec = 0.4
...
#         score_rec_seq=score_rec_seq,
#     )
#     p = {"g": "../gt.zip", "s": evaluate_result_path}
