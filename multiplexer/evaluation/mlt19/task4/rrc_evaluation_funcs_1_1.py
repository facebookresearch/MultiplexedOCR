...
def get_tl_dict_values(
    ...
    if "points" not in detection:
        raise Exception("Incorrect format. Object has no  ints key)")
...
def print_eval_result(eval_result, languages=None):
    ...
    print(f"~~Task 4 Summary{language_info}~~")
    print(eval)
    print("H-mean{}: {:.4f}".format(language_info, eval["hmeanUpper"]))
    print("Precision{}: {:.4f}".format(language_info, eval["precisionUpper"]))
    print("Recall{}: {:.4f}".format(language_info, eval["recallUpper"]))
    print("AP{}: {:.4f}".format(language_info, eval["AP"]))
    print("1-NED{}: {:.4f}".format(language_info, eval["nedUpper"]))
    print("1-NED (Case Sens.){}: {:.4f}".format(language_info, eval["ned"]))
    print("Hmean (Case Sens.){}: {:.4f}".format(language_info, eval["hmean"]))
    print("~~~~~~~~~~~~~~~~~~~~")
